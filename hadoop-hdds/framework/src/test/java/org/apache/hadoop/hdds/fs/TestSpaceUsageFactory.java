...
public class TestSpaceUsageFactory {
  ...
  /**
   * Verifies that SpaceUsageCheckFactory.create creates
  ...
  protected static <T extends SpaceUsageCheckFactory> T testCreateViaConfig(
    ...
    ConfigurationSource conf = configFor(factoryClass);
  ...
  private static <T extends SpaceUsageCheckFactory> ConfigurationSource
  ...
  private static void testDefaultFactoryForBrokenImplementation(
    ...
    ConfigurationSource conf = configFor(brokenImplementationClass);
