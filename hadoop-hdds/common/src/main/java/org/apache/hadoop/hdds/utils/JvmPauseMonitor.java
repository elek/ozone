...
public class JvmPauseMonitor {
  ...
  protected void serviceInit(ConfigurationSource conf) throws Exception {
    this.warnThresholdMs =
        conf.getLong(WARN_THRESHOLD_KEY, WARN_THRESHOLD_DEFAULT);
    this.infoThresholdMs =
        conf.getLong(INFO_THRESHOLD_KEY, INFO_THRESHOLD_DEFAULT);
  }
